      ...
      <div className="px-6 lg:px-12 mt-12 space-y-16">
        <section>
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl font-bold border-l-4 border-gold pl-4">Now Showing</h2>
...
const MovieCard = ({ movie }: { movie: any, key?: string }) => (
  <Link to={`/movie/${movie.id}`} className="group">
    ...
    <h3 className="font-bold text-lg group-hover:text-gold transition-colors truncate">{movie.title}</h3>
